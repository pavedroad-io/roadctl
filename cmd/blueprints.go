...
const (
	...
	checkWithSonar    string = "check: dbclean lint docker-build sonar-scanner $(ARTIFACTS) $(LOGS) $(ASSETS) $(DOCS)"
	checkWithoutSonar string = "check: dbclean lint docker-build $(ARTIFACTS) $(LOGS) $(ASSETS) $(DOCS)"
